...
typedef NS_ENUM(NSUInteger, FCPPlatformPrimaryConstituentDeviceSwitchingBehavior) {
  FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorUnsupported = 0,
  FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorAuto = 1,
  FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorRestricted = 2,
  FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorLocked = 3,
};

/// Wrapper for FCPPlatformPrimaryConstituentDeviceSwitchingBehavior to allow for nullability.
@interface FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorBox : NSObject
@property(nonatomic, assign) FCPPlatformPrimaryConstituentDeviceSwitchingBehavior value;
- (instancetype)initWithValue:(FCPPlatformPrimaryConstituentDeviceSwitchingBehavior)value;
@end

typedef NS_ENUM(NSUInteger, FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorCondition) {
  FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionVideoZoomChanged = 0,
  FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionFocusChanged = 1,
  FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionExposureChanged = 2,
};

/// Wrapper for FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorCondition to allow for nullability.
@interface FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionBox : NSObject
@property(nonatomic, assign) FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorCondition value;
...
- (void)setPrimaryConstituentDeviceSwitchingBehavior:(FCPPlatformPrimaryConstituentDeviceSwitchingBehavior)behavior withRestrictedSwitchingBehaviorConditions:(NSArray<FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionBox *> *)conditions completion:(void (^)(FlutterError *_Nullable))completion;
