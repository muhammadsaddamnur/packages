...
@implementation FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorBox
- (instancetype)initWithValue:(FCPPlatformPrimaryConstituentDeviceSwitchingBehavior)value {
  self = [super init];
  if (self) {
    _value = value;
  }
...
@implementation FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionBox
- (instancetype)initWithValue:(FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorCondition)value {
  self = [super init];
  if (self) {
    _value = value;
  }
...
- (nullable id)readValueOfType:(UInt8)type {
  switch (type) {
    ...
    case 139: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 140: {
      NSNumber *enumAsNumber = [self readValue];
      return enumAsNumber == nil ? nil : [[FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionBox alloc] initWithValue:[enumAsNumber integerValue]];
    }
    case 141: 
...
- (void)writeValue:(id)value {
  if ([value isKindOfClass:[FCPPlatformCameraLensDirectionBox class]]) {
    ...
    [self writeByte:138];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorBox class]]) {
    FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorBox *box = (FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorBox *)value;
    [self writeByte:139];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
  } else if ([value isKindOfClass:[FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionBox class]]) {
    FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionBox *box = (FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionBox *)value;
    [self writeByte:140];
    [self writeValue:(value == nil ? [NSNull null] : [NSNumber numberWithInteger:box.value])];
...
void SetUpFCPCameraApiWithSuffix(id<FlutterBinaryMessenger> binaryMessenger, NSObject<FCPCameraApi> *api, NSString *messageChannelSuffix) {
  ...
  /// Sets the primary constituent device switching behavior.
  {
    FlutterBasicMessageChannel *channel =
      [[FlutterBasicMessageChannel alloc]
        initWithName:[NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.camera_avfoundation.CameraApi.setPrimaryConstituentDeviceSwitchingBehavior", messageChannelSuffix]
        binaryMessenger:binaryMessenger
        codec:FCPGetMessagesCodec()];
    if (api) {
      NSCAssert([api respondsToSelector:@selector(setPrimaryConstituentDeviceSwitchingBehavior:withRestrictedSwitchingBehaviorConditions:completion:)], @"FCPCameraApi api (%@) doesn't respond to @selector(setPrimaryConstituentDeviceSwitchingBehavior:withRestrictedSwitchingBehaviorConditions:completion:)", api);
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        NSArray<id> *args = message;
        FCPPlatformPrimaryConstituentDeviceSwitchingBehaviorBox *boxedFCPPlatformPrimaryConstituentDeviceSwitchingBehavior = GetNullableObjectAtIndex(args, 0);
        FCPPlatformPrimaryConstituentDeviceSwitchingBehavior arg_behavior = boxedFCPPlatformPrimaryConstituentDeviceSwitchingBehavior.value;
        NSArray<FCPPlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorConditionBox *> *arg_conditions = GetNullableObjectAtIndex(args, 1);
        [api setPrimaryConstituentDeviceSwitchingBehavior:arg_behavior withRestrictedSwitchingBehaviorConditions:arg_conditions completion:^(FlutterError *_Nullable error) {
          callback(wrapResult(nil, error));
        }];
      }];
    } else {
