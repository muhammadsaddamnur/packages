...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(138);
      writeValue(buffer, value.index);
    }    else if (value is PlatformPrimaryConstituentDeviceSwitchingBehavior) {
      buffer.putUint8(139);
      writeValue(buffer, value.index);
    }    else if (value is PlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorCondition) {
      buffer.putUint8(140);
      writeValue(buffer, value.index);
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 139: 
        final value = readValue(buffer) as int?;
        return value == null ? null : PlatformPrimaryConstituentDeviceSwitchingBehavior.values[value];
      case 140: 
        final value = readValue(buffer) as int?;
        return value == null ? null : PlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorCondition.values[value];
      case 141: 
...
class CameraApi {
  ...
  Future<void> setPrimaryConstituentDeviceSwitchingBehavior(PlatformPrimaryConstituentDeviceSwitchingBehavior behavior, List<PlatformPrimaryConstituentDeviceRestrictedSwitchingBehaviorCondition> conditions) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.camera_avfoundation.CameraApi.setPrimaryConstituentDeviceSwitchingBehavior$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[behavior, conditions]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
